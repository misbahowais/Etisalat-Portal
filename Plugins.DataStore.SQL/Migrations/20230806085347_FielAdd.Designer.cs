...
namespace Plugins.DataStore.SQL.Migrations
{
    ...
    [Migration("20230806085347_FielAdd")]
    partial class FielAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreBusiness.Models.CompanyUserShortlistedJobSeeker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CompanyUserShortlistedJobSeeker", (string)null);
                });
            ...
            modelBuilder.Entity("CoreBusiness.Models.JobSeekerLanguage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("JobSeekerLanguage", (string)null);
                });
            ...
            modelBuilder.Entity("CoreBusiness.Models.Package", b =>
                {
                    ...
                    b.Property<int>("CandidatesShortlist")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreBusiness.Models.CompanyJob", b =>
                {
                    ...
                    b.HasOne("CoreBusiness.Models.Country", "Country")
                        .WithMany("CompanyJobCountry")
                        .HasForeignKey("CountryId")
                        .IsRequired()
                        .HasConstraintName("FK_CompanyJob_Country");
            ...
            modelBuilder.Entity("CoreBusiness.Models.CompanyUserShortlistedJobSeeker", b =>
                {
                    b.HasOne("CoreBusiness.Models.CompanyUser", "CompanyUser")
                        .WithMany("CompanyUserShortlistedJobSeekers")
                        .HasForeignKey("CompanyUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_CompanyUserShortlistedJobSeeker_CompanyUser");
                    ...
                    b.HasOne("CoreBusiness.Models.JobSeeker", "JobSeeker")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_CompanyUserShortlistedJobSeeker_JobSeeker");
            ...
            modelBuilder.Entity("CoreBusiness.Models.JobSeekerLanguage", b =>
                {
                    b.HasOne("CoreBusiness.Models.JobSeeker", "JobSeeker")
                        ...
                        .HasForeignKey("JobSeekerId")
                        .IsRequired()
                        .HasConstraintName("FK_JobSeekerLanguage_JobSeeker");
            ...
            modelBuilder.Entity("CoreBusiness.Models.JobSeekerPersonalDetail", b =>
                {
                    ...
                    b.HasOne("CoreBusiness.Models.Country", "CurrentCountry")
                        .WithMany("JobSeekerPersonalDetailsCurr")
                        .HasForeignKey("CurrentCountryId")
                        .IsRequired()
                        .HasConstraintName("FK_JobSeekerPersonalDetail_Country1");
            ...
            modelBuilder.Entity("CoreBusiness.Models.CompanyUser", b =>
                {
                    b.Navigation("CompanyUserShortlistedJobSeekers");
                });
            ...
            modelBuilder.Entity("CoreBusiness.Models.Country", b =>
                {
                    ...
                    b.Navigation("CompanyJobCountry");

                    b.Navigation("JobSeekerEducationDetails");

                    b.Navigation("JobSeekerPersonalDetails");

                    b.Navigation("JobSeekerPersonalDetailsCurr");
                });
